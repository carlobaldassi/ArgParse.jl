function _precompile_()
    ...
    precompile(ArgParse.ParserState, (Array{String, 1}, ArgParse.ArgParseSettings, Bool,))
    precompile(ArgParse.ParserState, (Array{Any, 1}, ArgParse.ArgParseSettings, Bool,))
    ...
    precompile(ArgParse.ArgParseSettings, ())
    ...
    precompile(ArgParse.ArgParseTable, ())
    ...
    precompile(ArgParse.ArgConsumerType, (Symbol,))
    precompile(ArgParse.ArgConsumerType, (Int64,))
    ...
    precompile(ArgParse.ArgConsumerType, (Char,))
    ...
    precompile(ArgParse.ArgParseError, (String,))
